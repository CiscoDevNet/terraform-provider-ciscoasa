		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.2.source", "192.168.10.0/23"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.2.destination", "192.168.12.0/23"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.2.destination_service", "icmp/0"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.2.active", "true"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.2.permit", "true"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.0.source", "192.168.10.5/32"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.0.destination", "192.168.15.0/25"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.0.destination_service", "tcp/443"),
					resource.TestCheckResourceAttr(
					...
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.1.source_service", "udp"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.1.destination", "192.168.15.6/32"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.1.destination_service", "udp/53"),
					resource.TestCheckResourceAttr(
...

			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.2.source", "192.168.10.0/23"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.2.destination", "192.168.12.0/24"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.2.destination_service", "icmp/8"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.2.active", "true"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.2.permit", "true"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.1.source", "192.168.12.0/24"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.1.source_service", "tcp"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.1.destination", "192.168.15.16/32"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.1.destination_service", "tcp/53"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.1.active", "true"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.1.permit", "true"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.0.source", "192.168.10.0/24"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.0.destination", "192.168.15.0/25"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.0.destination_service", "tcp/443"),
