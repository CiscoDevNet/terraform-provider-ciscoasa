		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.1860076939.source", "192.168.10.5"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.1860076939.destination", "192.168.15.0/25"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.1860076939.destination_service", "tcp/443"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.1860076939.active", "true"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.1860076939.permit", "true"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.3786451327.source", "192.168.10.0/24"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.3786451327.source_service", "udp"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.3786451327.destination", "192.168.15.6"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.3786451327.destination_service", "udp/53"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.3786451327.active", "true"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.3786451327.permit", "true"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.3651644684.source", "192.168.12.0/24"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.3651644684.source_service", "tcp"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.3651644684.destination", "192.168.15.16"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.3651644684.destination_service", "tcp/53"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.3651644684.active", "true"),
					resource.TestCheckResourceAttr(
						"ciscoasa_access_out_rules.foo", "rule.3651644684.permit", "true"),
					resource.TestCheckResourceAttr(
